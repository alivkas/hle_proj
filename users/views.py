...
def viewMessage(request, pk):
    ...
    if message.is_read == False:
        ...
        message.save()
    context = {'message': message, 'profile': profile, 'sender': sender}
    return render(request, 'users/mess.html', context)
...
def createMessage(request, username):
    ...
    context = {'recipient': recipient, 'form': form, 'unreadCount': unreadCount, 'profile': profile, 'sender': sender}
    return render(request, 'users/createMes.html', context)
